      ...
      <section id="prodotti" className="max-w-7xl mx-auto px-6 py-24">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold">
            Ghiaccio per ogni esigenza in Sardegna
          </h2>
        </div>
